...
export default function PersonalInfoForm({
  ...
  control: Control<PatientProfileForm>;
  setValue: UseFormSetValue<PatientProfileForm>;
  getValues?: UseFormGetValues<PatientProfileForm>;
}) {
  const [gender, setGender] = useState<string>(
    getValues && getValues("gender") ? arr[getValues("gender")] : "Male"
  );
  const [showCalendar, setShowCalendar] = useState<boolean>(false);
  const [date, setDate] = useState<string>(
    getValues ? getValues("dateOfBirth") : ""
  );
