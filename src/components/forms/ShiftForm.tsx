  ...
  const onSubmit = async (data: Shift) => {
    try {
      ...
      const response = await axios.patch(
        `${config.apiUrl}/Doctor/${doctor.doctorId}/shifts`,
        data
      );
                      ...
                      shiftTime.map((shiftTime) => {
                        return (
                          <ItemCard
                            name={shiftTime.time}
                            handleClick={() => {
                              toggleShift(shiftTime.shiftId);
                            }}
                            className={
                              removeMode &&
                              removedShifts.includes(shiftTime.shiftId)
                                ? "picked"
                                : removeMode
                                ? "highlighted"
                                : ""
